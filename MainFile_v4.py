...
f=open('/home/ec2-user/edot/edot/slave/energyscript/Template_86.idf');
w=open(filename,'w');
for line in f:
...
# Run EnergyPlus
WeatherFilePath = '/home/ec2-user/edot/edot/slave/energyscript/WeatherData/' + WeatherFile

#energyplus -w IND_Ahmedabad.426470_ISHRAE.epw -p ./Output/b -s C -x -m -r b_86.idf
cmd_test = "/usr/local/bin/energyplus -w "+ WeatherFilePath+ " -p /home/ec2-user/edot/edot/slave/energyscript/Output/b -s C -x -m -r "+filename 

print (cmd_test)
os.system("rm -rf /home/ec2-user/edot/edot/slave/energyscript/Output")
os.system("mkdir /home/ec2-user/edot/edot/slave/energyscript/Output")
os.system(cmd_test)

# # Fetch EnergySimualtion resutls
time.sleep(1)
#os.system("clear")
#os.system("python fetchResults.py")
html = open('/home/ec2-user/edot/edot/slave/energyscript/Output/bTable.htm')
...
# #TotalEnergy = fetch_TotalSiteEnergy('./Output/bTable.html')
