...
# This is  for more than three floors building, Finally it will generate template file. It has three floors Ground Floor, Mid Floor, and Top Floor. 
# zone multiplier is used for Mid Floor to get multi Floor building.  
# April 26 2017 
...
#DDY File
print "DDY File"
file_DDY=open("02B_SizingWeatherFile.idf","r")
g_2=file_DDY.read()
f.write(g_2)
file_DDY.close()
...
# Zones
print "Zones"
file_Zones=open("05_Zones_MultiFloors.idf","r")
g_5=file_Zones.read()
f.write(g_5)
file_Zones.close()
